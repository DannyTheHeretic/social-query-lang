...
def init_auth_modal() -> None:
    ...
    global AUTH_MODAL, LOGIN_BTN, STEALTH_BTN, USERNAME_INPUT, PASSWORD_INPUT, AUTH_FORM
...
def on_stealth_click(event: Event) -> None:
...
def on_auth_complete(auth_result: dict) -> None:
    """Complete authentication and show interfac."""
